...
Put the start node in the open list (priority queue).

The open list stores nodes to be explored, sorted by their f = g + h value.

Repeat until destination is found or open list is empty
...
ℎ = max(Δ𝑥,Δ𝑦)+(2−1)×min⁡(Δ𝑥,Δ𝑦)

Where:
Δ𝑥=∣𝑥𝑐𝑢𝑟𝑟𝑒𝑛𝑡−𝑥𝑔𝑜𝑎𝑙∣Δx=∣xcurrent−xgoal∣
Δ𝑦=∣𝑦𝑐𝑢𝑟𝑟𝑒𝑛𝑡−𝑦𝑔𝑜a𝑙∣
Δy=∣ycurrent-ygoal∣ 
